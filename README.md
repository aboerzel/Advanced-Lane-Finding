...
In order to adapt the current solution to the real life conditions, I will analyze as many pictures of extreme situations as possible and try to generate suitable binary images for those.